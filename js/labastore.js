...
myApp.addNotification({
	title: 'Thông Báo!',
	message: 'Hiện tại LaBaStore đã có bản cập nhật mới. Vui lòng bạn cập nhật để được trải nghiệm tốt nhất!',
	media: '<img width="44" height="44" style="border-radius:100%" src="img/20181027053235.png">',
	closeOnClick: true,
	onClick: ()=>{
		window.open("https://hpw2ntp.github.io/store/app.html")
	}
});
